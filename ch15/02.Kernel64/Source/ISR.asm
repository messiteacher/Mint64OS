...
; 콘텍스트를 복원하는 매크로
%macro KLOADCONTEXT 0   ; 파리미터를 전달받지 않은 KLOADCONTEXT 매크로 정의
...
kISRDoubleFault:
    ...
    ; 핸들러에 예외 번호와 에러 코드를 삽입하고 핸드러 호출
    mov rdi, 8
    mov rsi, qword [rbp + 8]
    call kCommonExceptionHandler
