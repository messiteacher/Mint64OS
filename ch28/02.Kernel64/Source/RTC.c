...
void kReadRTCTime(BYTE* pbHour, BYTE* pbMinute, BYTE* pbSecond) {
    ...
    *pbMinute = RTC_BCDTOBINARY(bData);
    ...
    // CMOS 메모리 어드레스 레지스터(포트 0x70)에 초을 저장하는 레지스터 지정
